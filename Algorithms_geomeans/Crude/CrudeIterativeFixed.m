function [ M, tTot, varargout ] = CrudeIterativeFixed( A )
%CRUDEITERATIVEFIXED(A) : estimation of the Karcher mean by using a combination
%of the Crude and Iterative means. The cycle chosen at each iteration is 
%fixed since the beginning of the algorithm.

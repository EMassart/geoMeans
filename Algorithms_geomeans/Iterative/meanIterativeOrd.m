function [ M, tTot, varargout] = meanIterativeOrd( A )
%MEANITERATIVEORD(A) estimates the Karcher mean using the Iterative algorithm proposed in [1].
%The cycle chosen is the same for all iterations.
